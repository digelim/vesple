/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min.js */
try{
/*!
...
/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/frontend/add-to-cart.min.js */
try{
...
/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min.js */
try{
/*!
 * SelectWoo 1.0.6
...
/* http://localhost/vesple/wp-admin/js/password-strength-meter.min.js */
try{
...
/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/frontend/password-strength-meter.min.js */
try{
...
/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min.js */
try{
/*!
...
/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js */
try{
...
/* http://localhost/vesple/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min.js */
try{
...
/* http://localhost/vesple/wp-content/themes/vesple/assets/js/navigation.min.js */
try{
...
/* http://localhost/vesple/wp-content/themes/vesple/assets/js/skip-link-focus-fix.min.js */
try{
...
/* http://localhost/vesple/wp-content/themes/vesple/assets/js/vendor/pep.min.js */
try{
/*!
 * PEP v0.4.3 | http://github.com/jquery/PEP
...
/* http://localhost/vesple/wp-includes/js/underscore.min.js */
try{
...
/* http://localhost/vesple/wp-includes/js/wp-util.min.js */
try{
...
/* http://localhost/vesple/wp-content/themes/vesple/js/main.js */
try{
window.observe={aInternal:10,aListener:function(val){},set simulationYears(val){this.aInternal=val;this.aListener(val)},get simulationYears(){return this.aInternal},registerListener:function(listener){this.aListener=listener}}
window.observe.simulationYears=5;jQuery(document).ready(function($){$.fn.inputFilter=function(inputFilter){return this.on("input keydown keyup mousedown mouseup select contextmenu drop",function(){if(inputFilter(this.value)){this.oldValue=this.value;this.oldSelectionStart=this.selectionStart;this.oldSelectionEnd=this.selectionEnd}else if(this.hasOwnProperty("oldValue")){this.value=this.oldValue;this.setSelectionRange(this.oldSelectionStart,this.oldSelectionEnd)}else{this.value=""}})};$('input[type="tel"]').inputFilter(function(value){return/^\d*$/.test(value)});$('.form-switch input').on('change',function(){$('.comparison-table-quantity, .comparison-table-percents').toggle()});$('.icon-edit').on('click',function(e){e.preventDefault();$('.investment-period').html('');$('.investment-period').focus()});$('.investment-period').on('keypress',function(e){if(isNaN(String.fromCharCode(e.which)||e.key===' '||e.key==='Spacebar'))e.preventDefault()});$('.investment-period').on('keydown',function(e){var currentValue=Number($(e.currentTarget).text());var typed=Number(String.fromCharCode(e.which));var prohibitedNumbers=[1,2,3,4,5,6,7,8,9];var isProhibited=$.inArray(currentValue,prohibitedNumbers)&&currentValue>3||currentValue===3&&typed!==0;var isDeleteOrBackspaceKey=e.which==8||e.which==46;if((currentValue>30||isProhibited)&&!isDeleteOrBackspaceKey){e.preventDefault()}});$('.investment-period').on('blur',function(){window.observe.simulationYears=Math.min(30,Number($('.investment-period').text()))||5;$('.investment-period').html(window.observe.simulationYears)})});

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* http://localhost/vesple/wp-includes/js/dist/vendor/moment.min.js */
try{
...
/* http://localhost/vesple/wp-content/themes/vesple/assets/js/woocommerce/header-cart.min.js */
try{
document.body.classList.contains("woocommerce-cart")||document.body.classList.contains("woocommerce-checkout")||window.innerWidth<768||!document.getElementById("site-header-cart")||window.addEventListener("load",function(){document.querySelector(".site-header-cart").addEventListener("mouseover",function(){var e=window.outerHeight,t=this.querySelector(".widget_shopping_cart_content").getBoundingClientRect().bottom+this.offsetHeight,o=this.querySelector(".cart_list");e<t&&(o.style.maxHeight="15em",o.style.overflowY="auto")})});

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* http://localhost/vesple/wp-content/themes/vesple/assets/js/footer.min.js */
try{
...
/* http://localhost/vesple/wp-includes/js/wp-embed.min.js */
try{

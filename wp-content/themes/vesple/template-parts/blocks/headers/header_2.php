...
$bottom_padding = get_field('bottom_padding');
  ...
  $image = get_field('image') ?: get_stylesheet_directory_uri() . '/images/header-2-image-placeholder.svg';
...
<header class="bg-img header_2 <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">

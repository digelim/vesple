...
<header class="bg-img header_1 align-center <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">
    ...
    <?php
      ...
      if( have_rows('buttons') ):
        ...
        <div data-aos="fade-up" data-aos-delay="500" class="btns-group justify-content-center">

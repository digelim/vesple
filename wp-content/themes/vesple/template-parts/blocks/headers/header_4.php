...
<header class="bg-img header_4 align-center <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">
    <h1 data-aos="fade-up"class="<?php echo $heading_size; ?> m-b-40 <?php echo $text_color; ?>"><?php echo $heading; ?></h1>

    <?php

      if( have_rows('buttons') ):
        ?>
        <div class="btns-group justify-content-center" data-aos="fade-up" data-aos-delay="250">
          <?php

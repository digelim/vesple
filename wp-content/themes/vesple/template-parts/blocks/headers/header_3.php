...
$bottom_padding = get_field('bottom_padding');
  ...
  $image = get_field('image') ?: get_stylesheet_directory_uri() . '/images/header-3-image-placeholder.svg';
...
<header class="bg-img header_3 <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">

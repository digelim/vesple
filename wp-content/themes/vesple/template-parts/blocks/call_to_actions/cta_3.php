...
<section class="bg-img cta_3 align-center <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">
    <h1 class="<?php echo $heading_size; ?> m-b-40 <?php echo $text_color; ?>"><?php echo $heading; ?></h1>

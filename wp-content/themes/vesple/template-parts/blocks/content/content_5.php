...
<section class=" bg-img content_5 <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  ...
  <?php
    ...
    switch ( $benefits_count ) {
      ...
      case 3:
        ...
        break;
      case 4:
        $responsive_class = ' responsive-1200';

        break;
    }
  ?>

  <div class="container row align-items-center margin-auto flex-column <?php echo $width_class; ?>">
    <h1 data-aos="fade-up" data-aos-delay="0" class="<?php echo $heading_size; ?> m-b-60 width-950 margin-auto align-center <?php echo $text_color; ?>"><?php echo $heading; ?></h1>
    <div class="row align-left justify-content-between margin-auto">

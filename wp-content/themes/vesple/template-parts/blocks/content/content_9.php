...
$bottom_padding = get_field('bottom_padding');
  ...
  $image = get_field('image') ?: get_stylesheet_directory_uri() . '/images/content-9-image-placeholder.svg';

?>

<section class=" bg-img content_9 <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">

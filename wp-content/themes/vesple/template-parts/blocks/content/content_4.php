...
$bottom_padding = get_field('bottom_padding');
  ...
  $image = get_field('image') ?: get_stylesheet_directory_uri() . '/images/content-4-image-placeholder.svg';
  $overlay_color = get_field('overlay_color') ?: 'rgba(0,0,0,0)';
  $overlay_opacity = get_field('overlay_opacity') ?: 0;

?>

<section class="content_4 <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="flex-44">
        <h1 data-aos="fade-up" class="<?php echo $heading_size; ?> m-b-20 margin-auto <?php echo $text_color; ?>"><?php echo $heading; ?></h1>
        <p data-aos="fade-up" data-aos-delay="250" class="subtitle large m-b-60 margin-auto <?php echo $text_color; ?>"><?php echo $subtitle; ?></p>
          ...
          <?php
            ...
            if( have_rows('benefits_row') ):
                ...
                ?>
                <div class="row benefit-row" data-aos="fade-up" data-aos-delay="250" >
                  <div class="fex-8 m-r-20">
                    <img src="<?php echo get_sub_field('image') ?: bloginfo('stylesheet_directory') . '/images/placeholder.svg'; ?>" alt="Image">
                  </div>
                  <div class="col <?php echo $text_color; ?>">

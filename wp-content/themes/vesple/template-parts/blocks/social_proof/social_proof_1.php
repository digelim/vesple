...
<section class="default-paddings social_proof_1 bg-img <?php echo $top_padding . ' ' . $bottom_padding; ?>" id="<?php echo esc_attr($id); ?>">
        ...
        if( have_rows('testimonials_row') ):
            ...
            while ( have_rows('testimonials_row') ) : the_row();
                ...
                <div class="testimonial">
                  <h4 class="type-regular width-650 margin-auto m-b-40"><?php the_sub_field('text'); ?></h4>
                  <img class="m-b-10" src="<?php the_sub_field('client') ?>" alt="Client">
